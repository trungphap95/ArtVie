<template>
  <div>
    <index-navbar />
    <section
      class="header section-first relative pt-16 items-center flex h-screen max-h-860-px"
      :style="'background-image: url(' + backgroundHeader +')'"
    >
      <div class="container mx-auto items-center flex flex-wrap">
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            <h2 class="font-semibold text-5xl text-white">
              Get royalty free music and SFX for your videos
            </h2>
            <p class="mt-4 text-lg leading-relaxed text-white">
              Start creating amazing videos with unlimited music & SFX
            </p>
            <div class="mt-12">
              <a
                href="#"
                target="_blank"
                class="get-started text-white font-semibold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-red active:bg-red-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
              >
                Start Free Now
              </a>
              <a
                href="#"
                class="github-star ml-1 text-white font-semibold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-blueGray-700 active:bg-blueGray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                target="_blank"
              >
                Pricing
              </a>
    ...
    <section class="mt-48 md:mt-40 pb-40 relative bg-white">
      <div
      ...
      <div class="container mx-auto">
        <div class="flex flex-wrap items-center">
          ...
          >
            <div
              class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-red"
            >
              <img
                alt="..."
              ...
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col mt-4">
                  <div class="px-4 py-5 flex-auto">
                    <div
                      class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-red"
                    >
      ...
      <div class="container mx-auto overflow-hidden pb-20">
        <div class="flex flex-wrap items-center">
          <div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
            <div
              class="text-white p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-red"
            >
            ...
            <div class="block pb-6">
              <span
                class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-blueGray-500 bg-blueGray-50 uppercase last:mr-0 mr-2 mt-2"
              >
                Buttons
              </span>
              <span
            ...
            <a
              ...
              target="_blank"
              class="font-semibold text-red hover:text-blueGray-500 ease-linear transition-all duration-150"
            >
              View All
          ...
          <div class="w-full md:w-6/12 px-4 mr-auto ml-auto mt-32">
            <div class="justify-center flex flex-wrap relative">
              ...
              <div class="my-4 w-full lg:w-6/12 px-4 lg:mt-16">
                ...
                >
                  <div
                    class="bg-red shadow-lg rounded-lg text-center p-8 mt-8"
                  >
                    <img
                      alt="..."
                      class="shadow-md rounded-full max-w-full w-16 mx-auto p-2 bg-white"
          ...
          <div class="w-full text-center lg:w-8/12">
            ...
            <div class="sm:block flex flex-col mt-10">
              <a
                ...
                target="_blank"
                class="get-started text-white font-semibold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-2 bg-red active:bg-red-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
              >
                Get started
              </a>
              <a
                ...
                target="_blank"
                class="github-star sm:ml-1 text-white font-semibold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-blueGray-700 active:bg-blueGray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
              >
...
import backgroundHeader from "@/assets/img/section-bg-11.jpg";
